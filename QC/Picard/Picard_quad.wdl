workflow WGSmetrics{
    ...
    call genMELTfam{input:pre_melt=Pre_melt,List=LIST,Faresult=WGSfa.result,Moresult=WGSmo.result,P1result=WGSp1.result,S1result=WGSs1.result}
    output{
