...
workflow Bincov {
    ...
    scatter(Fam in Fams){
        ...
        call BCsample.BC_sample as BCsibling {input: bamfile=Fam[4],Chrlist=CHRLIST}
        call gather{input:Fa=BCfather.bc,Mo=BCmother.bc,P1=BCproband.bc,S1=BCsibling.bc}
    }
